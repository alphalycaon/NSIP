                                    ...
                                    <div class="email-detail-nano-content" tabindex="0" style="right: -16px;">
                                        <div id="email-detail-inner">
                                            <div id="email-detail-subject" class="clearfix">
                                                <span class="subject property-value">${expedienteIp.numeroIp}</span>
                                                                ...
                                                                <div class="tab-content">
                                                                    <div class="tab-pane fade in active" id="tab-general">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input disabled="" type="text" class="form-control" name="datosIp.fechaEvento" value="${expedienteIp.ip.datosIp.fechaEvento}">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="exampleInputEmail1">Hora del evento</label>
                                                                            <input disabled="" type="text" class="form-control" name="datosIp.horaEvento" value="${expedienteIp.ip.datosIp.horaEvento}">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="exampleInputEmail1">Asunto</label>
                                                                            <input disabled="" type="text" class="form-control" name="datosIp.asunto" value="${expedienteIp.ip.datosIp.asunto}">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="exampleInputEmail1">Participación</label>
                                                                            <input disabled="" type="text" class="form-control" name="datosIp.participacion" value="${expedienteIp.ip.datosIp.participacion}">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="exampleInputEmail1">Operativo</label>
                                                                            <input disabled="" type="text" class="form-control" name="datosIp.operativo" value="${expedienteIp.ip.datosIp.operativo}">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="exampleInputEmail1">Ubicación</label>
                                                                            <input disabled="" type="text" class="form-control" name="datosIp.ubicacion" value="${expedienteIp.ip.datosIp.ubicacion}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="tab-pane fade" id="tab-victima">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input disabled="" type="text" class="form-control" name="victimaIp.nombre" value="${expedienteIp.ip.victimaIp.nombre}">
                                                                        </div> 
                                                                        <div class="form-group">
                                                                            <label for="exampleInputEmail1">Apellido Paterno </label>
                                                                            <input disabled="" type="text" class="form-control" name="victimaIp.apellidoPaterno" value="${expedienteIp.ip.victimaIp.apellidoPaterno}">
                                                                        </div> 
                                                                        <div class="form-group">
                                                                            <label for="exampleInputEmail1">Apellido Materno </label>
                                                                            <input disabled="" type="text" class="form-control" name="victimaIp.apellidoMaterno" value="${expedienteIp.ip.victimaIp.apellidoMaterno}">
                                                                        </div>                                                
                                                                        <div class="form-group">
                                                                            <label for="exampleInputEmail1">Edad</label>
                                                                            <input disabled="" type="text" class="form-control" name="victimaIp.edad" value="${expedienteIp.ip.victimaIp.edad}">
                                                                        </div>                                          
                                                                        <div class="form-group">
                                                                            <label for="exampleInputEmail1">Sexo </label>
                                                                            <input disabled="" type="text" class="form-control" name="victimaIp.sexo" value="${expedienteIp.ip.victimaIp.sexo}">
                                                                        </div>                               
                                                                    </div>                                                                 
                                                                </div>
                                                            </div>
                                                                            ...
                                                                            <div class="tabs-wrapper" style="background-color: white;">
                                                                                ...
                                                                                <div class="tab-content">
                                                                                    <div class="tab-pane fade in active" id="tab-archivos">
                                                                                        <doc:explorerAndUpload numeroExpediente="${expedienteIp.numeroIp}"/>
                                                                                    </div>
                                                                                    <div class="tab-pane fade" id="tab-imagenes">
                                                                                        <doc:gallery  numeroExpediente="${expedienteIp.numeroIp}"/>
                                                                                    </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form role="form">
                                                    <div class="form-group form-group-select2">
                                                        ...
                                                        <input type="hidden" name="expedienteId" value="${expedienteIp.id}">
                                            ...
                                            <div class="modal-footer">                                                                           
                                                ...
                                                <g:actionSubmit id="btnModalCompartir" class="btn btn-primary" value="Aceptar" action="compartirExpedienteIp" controller="home"/>
