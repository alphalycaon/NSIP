                                                                        ...
                                                                        <div class="tabs-wrapper" style="background-color: white;">
                                                                            ...
                                                                            <div class="tab-content">
                                                                                <div class="tab-pane fade in active" id="tab-archivos">
                                                                                    <doc:explorerAndUpload numeroExpediente="COA-FG-XX-PGU-2014-PP-1"/>
                                                                                </div>
                                        ...
                                        <div class="modal-body">
                                            <form role="form">
                                                <div class="form-group form-group-select2">
                                                    ...
                                                    <input type="hidden" name="expedienteId2" value="0">
                                        ...
                                        <div class="modal-body">
                                            <form role="form">
                                                <div class="form-group form-group-select2">
                                                    ...
                                                    <input type="hidden" name="expedienteId" value="0">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form role="form">
                                                <div class="form-group form-group-select2">
                                                    <label>Compartir a:</label>
                                                    <input type="hidden" name="expedienteId3" value="0">
