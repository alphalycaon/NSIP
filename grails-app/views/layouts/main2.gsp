...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
    ...
    <!-- Mirrored from centaurus.adbee.technology/v5/pricing.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Dec 2014 17:43:43 GMT -->
        <head>
        ...
        <script src="${resource(dir: 'centaurus/js', file: 'gpd-data.js')}"></script>
        <script src="${resource(dir: 'centaurus/js', file: 'jquery.flot.js')}"></script>
        <script src="${resource(dir: 'centaurus/js', file: 'jquery.flot.min.js')}"></script>
        <script src="${resource(dir: 'centaurus/js', file: 'jquery.flot.pie.min.js')}"></script>
        <script src="${resource(dir: 'centaurus/js', file: 'jquery.flot.stack.min.js')}"></script>
        <script src="${resource(dir: 'centaurus/js', file: 'jquery.flot.resize.min.js')}"></script>
        <script src="${resource(dir: 'centaurus/js', file: 'jquery.flot.time.min.js')}"></script>
        <script src="${resource(dir: 'centaurus/js', file: 'jquery.flot.threshold.js')}"></script>
...
<!--<script src="${resource(dir: 'centaurus/js', file: 'bootstrap.min.js')}"></script>-->
        ...
        <g:if test="${session.getAttribute("NSIP_NOTIFICACIONES") != null}">
            ...
            var varDenuncia='${session.getAttribute("NSIP_NOTIFICACIONES").get(websocket.tc7.chat.TipoNotificacion.DENUNCIA)}';
                ...
                }else if(obj.notificacion==="DENUNCIA"){
                $('#ntf_Denuncia').text(contador);
                    ...
                    <div class="clearfix">
                        ...
                        <div class="nav-no-collapse navbar-left pull-left hidden-sm hidden-xs">
                            <g:form name="buscarForm" controller="Busqueda" action="index" class="form-inline" role="form">                                                                                
                                <ul class="nav navbar-nav pull-left">
                                    ...
                                    <li>
                                        <a class="btn" id="btnBusqueda" onclick="$('#buscarForm').submit();">
                        ...
                        <div class="nav-no-collapse pull-right" id="header-nav">
                            <ul class="nav navbar-nav pull-right"> 
                                ...
                                <!--li class="dropdown hidden-xs">
                                    ...
                                    <ul class="dropdown-menu notifications-list messages-list">
                                        ...
                                        <li class="item first-item">
                                            <a href="#">
                                                <img src="${resource(dir: 'centaurus/img/samples', file: 'messages-photo-1.png')}/" alt=""/>
                                                <span class="content">
                                ...
                                <li class="hidden-xs">
                                    <a class="btn" id="startTourBtn">
                                        <i class="fa fa-question-circle"></i>
                                    </a>
                                </li>
                                <li class="dropdown profile-dropdown" id="profileUsuario">
                                    ...
                                    <ul class="nav nav-pills nav-stacked">
                                        ...
                                        <shiro:hasRole name="Juez"><!--
                                            <li>
                                                <a href="${request.contextPath}">
                                                    <i  class="fa fa-inbox"></i>
                                                    <span style="font-size: 10px;">Mis Causas</span>
