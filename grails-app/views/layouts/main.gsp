...
<html>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="${resource(dir: 'centaurus/css/compiled', file='calendar.css')}" />
    ...
    <link rel="stylesheet" type="text/css" href="${resource(dir: 'centaurus/css/libs', file:'fullcalendar.print.css')}" />
